function resizeView() {
	...
	b.each(function() {
		...
		1 == a ? $(this).css("min-width", 100) : 2 == a ? $(this).css("min-width", 200) : a > 2 && $(this).css("min-width", 320)
	})
}! function(a) {
	"use strict";
	...
	function d(a, b, e) {
		...
		if (a)
			...
			for (f in a) Ed.call(a, f) && b.call(e, a[f], f, a);
		return a
	}
	...
	function N(a, b) {
		function c(a, b) {
			...
			if (Vd(a))
				...
				for (c in a) Ed.call(a, c) && (b[c] = e(a[c]));
			return h(b, d), b
		}
	...
	function da(a, b) {
		var c, d, e = ae.length;
		for (d = 0; e > d; ++d)
			if (c = ae[d] + b, v(c = a.getAttribute(c))) return c;
		return null
	}
		...
		this.onChangesTtl = function(a) {
			...
			function N(b, c, d, e, f) {
				...
				return function(a, c, d) {
					...
					var i;
					if (i = "html" !== l ? Kd(ja(l, Kd("<div>").append(b).html())) : c ? ye.clone.call(b) : b, g)
			...
			function U(a, b, c, d, e) {
				...
				switch (h) {
					case de:
						...
						if (g = a.className, t(g) && (g = g.animVal),
							v(g) && "" !== g)
							for (; f = u.exec(g);) l = qb(f[2]), ba(b, l, "C", d, e) && (c[l] = Xd(f[3])), g = g.substr(f.index + f[0].length);
						break;
					case fe:
						if (11 === Jd)
							for (; a.parentNode && a.nextSibling && a.nextSibling.nodeType === fe;) a.nodeValue = a.nodeValue + a.nextSibling.nodeValue, a.parentNode.removeChild(a.nextSibling);
						ha(b, a.nodeValue);
						break;
					case ge:
						try {
			...
			function Y(a, b, c, f, g, h, i, k, l) {
				...
				for (var o, p, q, s, u, v = -Number.MAX_VALUE, w = l.newScopeDirective, x = l.controllerDirectives, z = l.newIsolateScopeDirective, A = l.templateDirective, C = l.nonTlbTranscludeDirective, D = !1, E = !1, F = l.hasElementTranscludeDirective, G = c.$$element = Kd(b), H = h, J = f, K = !1, M = !1, O = 0, P = a.length; P > O; O++) {
					...
					if (!o.templateUrl && o.controller && (u = o.controller, x = x || pa(), ga("'" + p + "' controller", x[p], o, G), x[p] = o), u = o.transclude)
						if (D = !0, o.$$tlb || (ga("transclusion", C, o, G), C = o), "element" == u) F = !0, v = o.priority, q = G, G = c.$$element = Kd(N.$$createComment(p, c[p])), b = G[0], na(g, R(q), b), q[0].$$parentNode = q[0].parentNode, J = X(M, q, f, v, H && H.name, {
					...
					if (o.template)
						if (E = !0, ga("template", A, o, G), A = o, u = y(o.template) ? o.template(G, c) : o.template, u = za(u), o.replace) {
	...
	function Pc(a, b, c, d, e) {
		...
		switch (f) {
			case "object":
				...
				if (d) {
					for (h in a)
						if ("$" !== h.charAt(0) && Pc(a[h], b, c, !0)) return !0;
	...
	var Vd = Array.isArray,
		...
		$d = function() {
			...
			for (c = 0; f > c; ++c)
				if (d = ae[c], b = a.document.querySelector("[" + d.replace(":", "\\:") + "jq]")) {
			...
			switch (a.type) {
				...
				case qf.Identifier:
					b = b || this.nextId(), c && (c.context = "inputs" === m.stage ? "s" : this.assign(this.nextId(), this.getHasOwnProperty("l", a.name) + "?l:s"), c.computed = !1, c.name = a.name), ac(a.name), m.if_("inputs" === m.stage || m.not(m.getHasOwnProperty("l", a.name)), function() {
						...
						}, b && m.lazyAssign(b, m.nonComputedMember("l", a.name))), (m.state.expensiveChecks || qc(a.name)) && m.addEnsureSafeObject(b),
						e(b);
					break;
				case qf.MemberExpression:
		...
		function f(b, c) {
			...
			for (var e = k.firstChild; e;) {
				...
				if (!(f = e.firstChild) && (1 == e.nodeType && c.end(e.nodeName.toLowerCase()), f = e.nextSibling, !f))
					for (; null == f && (e = e.parentNode, e !== k);) f = e.nextSibling, 1 == e.nodeType && c.end(e.nodeName.toLowerCase());
				e = f
			}
	...
	function(a, b) {
		...
		var b = function(a) {
			var c, d, e, f, g, h, i, j = "";
			for (c in a)
				if (d = a[c], d instanceof Array)
					for (i = 0; i < d.length; ++i) g = d[i], e = c + "[" + i + "]", h = {}, h[e] = g, j += b(h) + "&";
				else if (d instanceof Object)
				for (f in d) g = d[f], e = c + "[" + f + "]", h = {}, h[e] = g, j += b(h) + "&";
		...
		function d() {
			...
			1 == a ? ($("body").addClass("main-lg-body"), $(".js-big-main").text("正常")) : ($("body").removeClass("main-lg-body"), $(".js-big-main").text("宽屏"))
		}
		...
		}), a(), b(), window.sysinfo.uid, window.sysinfo.module && window.sysinfo.module.name && $.getJSON("./index.php?c=utility&a=checkupgrade&do=module&m=" + window.sysinfo.module.name, function(a) {
			-10 == a.message.errno && $(".head").after('<div id="upgrade-tips-module" class="upgrade-tips we7-body-alert"><div class="alert-info text-center"><a href="http://wpa.b.qq.com/cgi/wpa.php?ln=1&key=XzkzODAwMzEzOV8xNzEwOTZfNDAwMDgyODUwMl8yXw" target="_blank">' + a.message.message + "</a></div></div>")
		}), window.sysinfo.isfounder && c(), $(".js-big-main").click(function() {
			var a = $("body").hasClass("main-lg-body") ? "0" : "1";
			util.cookie.set("main-lg", a), d()
		})
	}), window.UEDITOR_HOME_URL = "./resource/components/ueditor/", angular.module("app").directive("we7Colorpicker", [function() {
		var a = {
			...
			n = {
				...
				link: function(b, n, o) {
					n.find(".input-group-btn").mouseover(function(a) {
						...
						b.modalobj = util.dialog("请选择链接", ["./index.php?c=utility&a=link&callback=selectLinkComplete"], "", {
		...
		return {
			link: function(c, d, e) {
				...
				$(".right-hand-menu").length || ($("body").append(g), $(".modules").on("contextmenu", function(a) {
					...
					for (var h in c.activeModules)
						if (c.activeModules[h].index == f) {
					...
					c.savePagePosition();
					var d, e, f = $(".right-hand-menu").data("item-index");
					for (var g in c.activeModules)
						if (c.activeModules[g].index == f) {
							if (1 >= g) break;
		...
		return {
			compile: function(b, c) {
				...
				return b.append(d).append(e).append(f).append(g),
					function(b, c, d) {
		...
		return {
			compile: function(a, b) {
				...
				return a.find(".bar-n,.bar-s,.bar-e,.bar-w").append(c), a.append(e).append(f).append(g).append(d),
					function(a, b, c) {
				...
				e.on("mousedown", function(b) {
					...
					g.get("pan").set({
						...
						var d = b.center,
							...
							i = Math.abs(e / g);
						c = Math.atan(i) / (2 * Math.PI) * 360, e > 0 && 0 > g ? c = 360 + c : e > 0 && g > 0 ? c = 180 - c : 0 > e && g > 0 ? c = 180 + c : 0 > e && 0 > g && (c = 360 - c),
							c > 360 && (c -= 360), c = parseInt(c), f.css({
		...
		return {
			...
			link: function(a, b, c) {
				a.$watch("we7svg", function() {
					for (var c = $(a.we7svg), d = 0; c.length > d; d++)
						if ("svg" == c[d].tagName) {
							var e = c[d];
							$(e).attr({
								width: "100%",
		...
		return g.setModules = function(a, c) {
			if (_.isNull(a) && (h.modules = b), _.isArray(a))
				for (i in a) {
		...
		if (a.activeItem.params && a.activeItem.params.layout && _.isEmpty(a.activeItem.params.layout))
			for (row = 0; row < 4; row++)
		...
		$(".layout-table").bind("mouseover", function(a) {
			...
			for (_.isUndefined(d) && (d = 0), _.isUndefined(e) && (e = 0), a.activeItem.params.layout[b][c] = {
				...
				}, i = b; i < parseInt(b) + parseInt(d); i++)
				for (j = c; j < parseInt(c) + parseInt(e); j++) b == i && c == j || delete a.activeItem.params.layout[i][j];
			...
			for (var b = 0; 4 > b; b++)
				for (var c = 0; 4 > c; c++)
					if (!_.isEmpty(a.activeItem.params.layout[b][c]) && a.activeItem.params.currentLayout.classname == a.activeItem.params.layout[b][c].classname) {
						if (a.activeItem.params.currentLayout.rows > 1)
							for (var d = 0; d < a.activeItem.params.currentLayout.rows; d++) {
								var e = b + d;
								if (a.activeItem.params.layout[e][c] = {
										...
										imgurl: "",
										classname: ""
									}, a.activeItem.params.currentLayout.cols > 1)
									for (var f = 0; f < a.activeItem.params.currentLayout.cols; f++) {
										var g = c + f;
		...
		a.page = {
			...
			for (var h in a.sysCategoryList)
				if (h == f) {
			...
			e = e.split("../"), b({
				...
				for (var c, d = $(b), e = d.length, f = 0; e > f; f++)
					if ("svg" == d[f].tagName) {
						c = d[f];
						break
					}
		...
		var c = function() {
			...
			e = function() {
				var b = [];
				if (a.page.numPages <= 5)
					for (var c = 1; c <= a.page.numPages; c++) a.page.currentPage == c ? b.push({
						number: c,
						active: !0
					}) : b.push({
						number: c,
					...
					if (d > 0)
						...
						for (var c = 1; 5 >= c; c++) a.page.currentPage == c ? b.push({
							number: c,
							active: !0
						}) : b.push({
							number: c,
	...
	}]), angular.module("wapeditorApp").controller("WhiteCtrl", ["$scope", function(a) {}]), angular.module("accountApp", ["app"]), angular.module("accountApp").controller("AccountDisplay", ["$scope", "$http", "$timeout", "config", function(a, b, c, d) {
			...
			switch (e) {
				...
				case "jointype":
					if ($("#jointype").modal("hide"), 1 == a.middleAccount.type && b.post(c.links.basePost, {
						...
						}), 3 == a.middleAccount.type)
						if (1 == c.authurl.errno) util.message(c.authurl.url);
						else {
				...
				case "endtime":
					$("#endtime").modal("hide");
					var g = a.middleAccount.endtype,
						h = $(':text[name="endtime"]').val();
					b.post(c.links.basePost, {
						type: e,
						endtype: g,
						endtime: h
					}).success(function(b) {
						0 == b.message.errno ? (a.account.endtype = g, a.account.end = 1 == g ? "永久" : h, util.message("到期时间修改成功！", "", "success")) : (-1 == b.message.errno && util.message(b.message.message, b.redirect, "error"), 1 == b.message.errno && util.message(b.message.message, "", "error"), 40035 == b.message.errno && util.message(b.message.message, "", "error"))
					});
					break;
				case "token":
					if ($("#token").modal("hide"), "undefined" == typeof f) {
						...
						var j = new RegExp(/^[A-Za-z0-9]{3,32}$/);
						if (!j.test(i)) return util.message("必须为英文或者数字，长度为3到32个字符！"), !1
					}
					b.post(c.links.basePost, {
						type: e,
						request_data: i
				...
				case "encodingaeskey":
					if ($("#encodingaeskey").modal("hide"), "undefined" == typeof f) {
						if (!confirm("确定要生成新的吗？")) return !1;
						var k = d.encodingAESKeyGen()
					} else {
						var k = $("#newencodingaeskey").val();
						if (0 == k.length) return util.message("不可为空！"), !1;
						var j = new RegExp(/^[A-Za-z0-9]{43}$/);
						if (!j.test(k)) return util.message("必须为英文或者数字，长度为43个字符！"), !1
					}
					b.post(c.links.basePost, {
						type: e,
						request_data: k
					}).success(function(b) {
						0 == b.message.errno ? (a.account[e] = k, util.message("修改成功！")) : (-1 == b.message.errno && util.message(b.message.message, b.redirect, "error"), 1 == b.message.errno && util.message(b.message.message, "", "error"), 40035 == b.message.errno && util.message(b.message.message, "", "error"))
					})
			}
		}
		...
		a.reply = {
			...
			entry: c.replydata
		}, a.reply.entry ? (a.reply.entry.istop = a.reply.entry.displayorder >= 255 ? 1 : 0, a.reply.status = 1 == a.reply.entry.status, a.reply.entry.keywords && (1 == a.reply.entry.reply_type && angular.forEach(a.reply.entry.keywords, function(a, b) {
			"1" == a.type && (this.exact += 0 == this.exact.length ? a.content : "," + a.content), "2" == a.type && (this.contain += 0 == this.contain.length ? a.content : "," + a.content), "3" == a.type && (this.regexp += 0 == this.regexp.length ? a.content : "," + a.content), "4" == a.type
		}, a.reply.keyword), 2 == a.reply.entry.reply_type && angular.forEach(a.reply.entry.keywords, function(b, c) {
			this.exact += 0 == this.exact.length ? b.content : "," + b.content, "2" == b.type && (a.reply.advanceTrigger = !0)
		}, a.reply.keyword))) : a.reply.entry = {
			istop: 0,
			reply_type: 2,
			displayorder: "",
			id: "",
			...
			if ("" == $.trim($(':text[name="rulename"]').val())) return util.message("必须输入回复规则名称"), !1;
			$(':hidden[name="reply_type"]').val(a.reply.entry.reply_type);
			var c = [];
			switch (parseInt(a.reply.entry.reply_type)) {
				case 1:
					var d = a.reply.keyword.exact.replace("，", ",").split(",");
					d = _.union(d), angular.forEach(d, function(a) {
						"" != a && c.push({
							type: 1,
							content: a
						})
					}, c);
					var e = a.reply.keyword.contain.replace("，", ",").split(",");
					e = _.union(e), angular.forEach(e, function(a) {
						"" != a && c.push({
							type: 2,
							content: a
						})
					}, c);
					var f = a.reply.keyword.regexp.replace("，", ",");
					"" != f && c.push({
						type: 3,
						content: f
					});
					break;
				case 2:
					if (a.reply.advanceTrigger) {
						var g = a.reply.keyword.exact.replace("，", ",").split(",");
						g = _.union(g), angular.forEach(g, function(a) {
							"" != a && c.push({
								type: 2,
								content: a
							})
			...
			if (0 == c.length) return util.message("请输入有效的触发关键字."), !1;
			if (c = angular.toJson(c), $(':hidden[name="keywords"]').val(c), $.isFunction(window.validateReplyForm)) {
				var h = window.validateReplyForm(this, $, _, util, a, b);
				if (!h) return !1;
				$(".reply-form-submit").click()
			} else $(".reply-form-submit").click()
		}, a.initEmotion = function(b) {
			2 == a.reply.entry.reply_type ? util.emotion($("#keyword-emoji"), $("#keyword-input-exact"), function(b, c, d) {
				a.reply.keyword.exact = $(d).val()
			}) : (util.emotion($("#emoji-exact"), $("#keyword-exact"), function(b, c, d) {
				a.reply.keyword.exact = $(d).val()
			}), util.emotion($("#emoji-indistinct"), $("#keyword-indistinct"), function(b, c, d) {
				a.reply.keyword.contain = $(d).val()
			}))
		}, a.checkKeyWord = function(a) {
			var d = $(a.target),
				e = d.val().trim();
			if ("" == e) return d.parent().next().next().text(""), !1;
			var f = (d.attr("data-type"), d.index(".keyword-input")),
				g = !0;
			return $(".keyword-input").each(function(a) {
				var b = $(this).val().trim();
				return e == b && f != a ? (g = !1, !1) : void 0
			}), g === !1 ? (d.parent().next().next().text(""), util.message("该关键字已重复存在于当前规则中."), !1) : void b.post("./index.php?c=platform&a=reply&do=post", {
				keyword: e
			}).success(function(a) {
				if (0 == a.message.errno) {
					...
					"" != f && d.parent().next().next().html("该关键字已存在于 " + f + " 规则中.")
				} else d.parent().next().next().text("")
			})
		}
		...
		a.changeStatus = function(a) {
			...
			b.post("./index.php?c=platform&a=reply&do=change_keyword_status", {
				...
				0 == b.message.errno ? (c.match("switchOn") ? $("#key-" + a).removeClass("switchOn") : $("#key-" + a).addClass("switchOn"), util.message("修改成功！")) : util.message("网络错误，请稍候重试")
			}).error(function(a) {
				util.message("网络错误，请稍候重试")
			})
		}
	}]), angular.module("replyFormApp").controller("serviceDisplay", ["$scope", "config", "$http", function(a, b, c) {
		a.config = b, a.userapi = b.userapi, a.changeStatus = function(b) {
			a.userapi[b]["switch"] = "" == a.userapi[b]["switch"] ? "checked" : "", c.post(a.config.url, {
				rid: b,
				m: "userapi"
			}).success(function(a) {
				0 == a.message.errno ? util.message("修改成功！") : util.message("网络错误，请稍候重试")
			})
		}
		...
		a.config = b, a.url = b.url, a.msgtypes = {
			...
			c.post(a.url, {
				...
				0 == c.message.errno ? (a.switch_class[b] = "switch switchOn special_switch" == a.switch_class[b] ? "switch special_switch" : "switch switchOn special_switch",
					util.message("修改成功！")) : util.message(c.message.message)
			})
		}
		...
		a.showToken = function() {
			...
			$.getJSON("./index.php?c=cloud&a=diagnose&do=testapi&ip=" + a.find("#serverdnsip").html(), function(b) {
				a.find("#checkresult").html(b.message)
			})
		}), $.ajax({
			type: "get",
			data: {
		...
		a.config = c, a.addTagUrl = c.addTagUrl, a.tag = "", a.searchMod = c.searchMod, a.closeValue = 0, a.switchSearchMod = function(b) {
			...
			e || (e = 0), void 0 == d && (d = "", util.message("正在下载粉丝数据...")), b.post(c.syncAllUrl, {
				next_openid: d
			}).success(function(b) {
			...
			if ("all" == e) f || (f = {}, f.pageindex = 0, f.total = 0, util.message("粉丝数据下载完成。开始更新粉丝数据...", "", "success")), f.type = "all";
			else {
				if (f = {
						type: "check",
						openids: []
			...
			if (f.pageindex > 0 && 0 == a.closeValue) {
				...
				var g = util.dialog("更新进度", '<div class="progress"> <div class="progress-bar progress-bar-info" role="progressbar" aria-valuenow="' + f.pageindex / f.total * 100 + '" aria-valuemin="0" aria-valuemax="100" style="width: ' + f.pageindex / f.total * 100 + '%"><span class="sr-only"></span></div></div>', "", {
	...
	}]), angular.module("massApp").controller("MassPost", ["$scope", "config", function(a, b) {
		a.groups = b.groups, a.massdata = b.massdata, a.clock = b.massdata ? b.massdata.clock : "08:00", $.isFunction(window.initReplyController) && window.initReplyController(a), a.checkSubmit = function(c) {
			var d = $(".mass-group").val();
			if ("" == d) return c.preventDefault(), util.message("请选择群发对象"), !1;
			if (angular.forEach(a.groups, function(a, b) {
					a.id == d && $(':hidden[name="group"]').val(angular.toJson(a))
				}), "" == a.clock) return c.preventDefault(), util.message("请选择群发具体时间"), !1;
			if ("0" == b.day) {
				var e = a.clock.split(":"),
					f = new Date,
					g = f.getHours(),
					h = f.getMinutes();
				if (e[0] < g || e[0] == g && e[1] < h) return c.preventDefault(), util.message("发送时间不能小于当前时间"), !1
			}
			return "" == $(':hidden[name="reply[reply_news]"]').val() && "" == $(':hidden[name="reply[reply_image]"]').val() && "" == $(':hidden[name="reply[reply_music]"]').val() && "" == $(':hidden[name="reply[reply_voice]"]').val() && "" == $(':hidden[name="reply[reply_video]"]').val() ? (c.preventDefault(), util.message("请选择群发素材"), !1) : void 0
		...
		a.days = c.days, a.delMass = function(c, d) {
			var c = parseInt(c),
				d = parseInt(d);
			return confirm("确认清空这条群发吗?") ? (b.post("./index.php?c=platform&a=mass&do=del", {
				id: c
		...
		a.materialList = c.materialList, a.groups = c.group, a.config = c, a.group = "", a.materialType = "", a.materialId = "", a.syncNews = c.syncNews, a.hidenbutton = 0, a.sync = function(d, e, f, g, h) {
			...
			util.message("素材转换将在后台运行，成功后后自动刷新页面，请勿关闭浏览器..."), b.post(c.trans_url, {
				material_id: e
			}).success(function(b) {
				0 != b.message.errno ? util.message("转换失败,具体原因:" + b.message.message, "", "info") : a.sync(d)
			})
		}, a.newsToWechat = function(c) {
			util.message("素材转换将在后台运行，成功后后自动刷新页面，请勿关闭浏览器..."), b.post(a.config.postwechat_url, {
				material_id: c
			}).success(function(a) {
				0 == a.message.errno ? util.message("已保存", "./index.php?c=platform&a=material", "success") : alert("创建图文失败" + a.message.message)
			})
		...
		a.config = b, a.operate = b.operate, a.changeClass = function() {
			a.hidenbutton = 0, angular.forEach(a.materialList, function(b, c) {
				"" != b.content_source_url && (a.hidenbutton = 1), "0" == c ? a.materialList[c]["class"] = a.activeIndex == c ? "cover-appmsg-item active" : "cover-appmsg-item" : a.materialList[c]["class"] = a.activeIndex == c ? "appmsg-item active" : "appmsg-item"
			}), angular.isObject(a.materialList[a.activeIndex]) && "" != a.materialList[a.activeIndex].content_source_url ? (a.hidenbutton = 1, $(".nav-tabs > li:first").attr("class", ""), $(".nav-tabs > li:last").attr("class", "active"), $("#appmsg-edit").attr("class", "tab-pane"), $("#appmsg-link").attr("class", "tab-pane active")) : ($(".nav-tabs > li:first").attr("class", "active"), $(".nav-tabs > li:last").attr("class", ""), $("#appmsg-edit").attr("class", "tab-pane active"), $("#appmsg-link").attr("class", "tab-pane"))
			...
			b.thumb_url = a.tomedia(b.thumb_url), "" != b.content_source_url && (a.hidenbutton = 1), a.materialList[c] = {
				id: b.id,
				title: b.title,
				author: b.author,
				thumb: b.thumb_url,
		...
		a.config = c, a.group_level = a.config.group_level, a.group_person_count = a.config.group_person_count, a.group_list = a.config.group_list, a.default_group = a.config.default_group, a.set_group_detail_info = function(c) {
			...
			return "" == a.group_detail.title ? (util.message("请填写会员组名称", "", "error"), !1) : void b.post(a.config.save_group_url, {
			...
			return confirm("确定要删除吗？") ? void b.post(a.config.del_group_url, {
				group_id: c
			}).success(function(b) {
		...
		push_url = b.push_url, a.changeStatus = function(a, b, d) {
			b = 1 == b ? 2 : 1, 3 == d && (1 == b ? $(".js-switch-" + a).addClass("switchOn") : 2 == b && $(".js-switch-" + a).removeClass("switchOn")), c.post(push_url, {
				id: a,
				status: b
			}).success(function(a) {
				0 == a.message.errno ? 3 == d ? util.message(a.message.message, a.redirect) : util.message(a.message.message, a.redirect) : 3 == d ? util.message(a.message.message, "error") : util.message(a.message.message, a.redirect, "error")
			})
		}
		...
		current_menu_url = b.current_menu_url, require(["underscore", "jquery.ui", "jquery.caret", "district"], function(a, b, b, c) {
			...
			}), b(".designer-y").sortable({
				items: "dd",
				axis: "y",
				cancel: ".js-not-sortable"
			}), b(".designer-x").sortable({
				items: ".js-sortable",
				axis: "x"
			})
			...
			return angular.forEach(d.button, function(a, b) {
				"" == $.trim(a.name) && (this.name += "第" + (b + 1) + "个一级菜单未设置菜单名称<br>"), a.sub_button.length > 0 ? angular.forEach(a.sub_button, function(c, d) {
					"" == $.trim(c.name) && (this.name += "第" + (b + 1) + "个一级菜单中的第" + (d + 1) + "个二级菜单未设置菜单名称<br>"), "view" == c.type && c.url.indexOf("http") < 0 && (this.action += "第" + (b + 1) + "个一级菜单中的第" + (d + 1) + "个二级菜单跳转链接缺少http标识<br>"), ("view" == c.type && "" == $.trim(c.url) || "click" == c.type && "" == c.media_id && "" == c.key || "view" != c.type && "click" != c.type && "" == $.trim(c.key)) && (this.action += "菜单【" + a.name + "】的子菜单【" + c.name + "】未设置操作选项. <br />")
				}, e) : ("view" == a.type && a.url.indexOf("http") < 0 && (this.action += "菜单【" + a.name + "】跳转链接缺少http标识. <br />"), ("view" == a.type && "" == $.trim(a.url) || "click" == a.type && "" == a.media_id && "" == a.key || "view" != a.type && "click" != a.type && "" == $.trim(a.key)) && (this.action += "菜单【" + a.name + "】不存在子菜单并且未设置操作选项. <br />"))
			...
			return -1 == c ? !1 : (a.context.activeIndex = c, a.context.activeBut = a.context.group.button[a.context.activeIndex], a.context.activeItem = a.context.activeBut, void(a.context.activeType = 1))
		}, a.context.editBut = function(b, d, e) {
			a.context.triggerActiveBut(d), b ? (a.context.activeItem = b, a.context.activeType = 2) : (a.context.activeItem = d, a.context.activeType = 1), e && (a.context.activeItem.material = [], "view" != a.context.activeItem.type && "click" != a.context.activeItem.type && (a.context.activeItem.key ? current_type = a.context.activeItem.key.substr(0, 6) : current_type = "click", "module" == current_type ? a.context.activeItem.etype = "module" : a.context.activeItem.etype = "click"), c.post(current_menu_url, {
				current_menu: a.context.activeItem
			}).success(function(b) {
			...
			if (!(a.context.group.button.length >= 3)) {
				...
				a.context.triggerActiveBut(b), $(".designer-x").sortable({
					items: ".js-sortable",
					axis: "x"
				})
			}
			...
			return 1 == a.context.group.disabled ? !1 : (a.context.triggerActiveBut(b), void(a.context.activeBut.sub_button.length >= 5 || (a.context.activeBut.sub_button.push({
				...
				axis: "y",
				cancel: ".js-not-sortable"
			}), a.context.activeItem = a.context.activeBut.sub_button[a.context.activeBut.sub_button.length - 1], a.context.activeType = 2)))
			...
			$.post(b.search_key_url, {
				...
				var b = $.parseJSON(b),
					...
					d = "";
				if (c > 0)
					for (var e = 0; c > e; e++) d += '<li><a href="javascript:;">' + b[e] + "</a></li>";
				else d += '<li><a href="javascript:;" id="no-result">没有找到您输入的关键字</a></li>';
				$("#key-result ul").html(d), $('#key-result ul li a[id!="no-result"]').click(function() {
		...
		a.config = c, a.moduleGroup = null === c.moduleGroup ? {
			...
			return param = {
				...
				modules: a.groupHaveModuleApp,
				wxapp: a.groupHaveModuleWxapp,
				templates: a.groupHaveTemplate
			}, "" === param.name || void 0 === param.name ? (util.message("请输入套餐名", "", "info"), !1) : void b({
				method: "POST",
				url: a.config.url,
				data: param,
				beforeSend: function() {
				...
				return 1 == a.message.errno ? (util.message(a.message.message, "", "info"), !1) : void util.message("提交成功", a.message.message, "success")
			})
		}
	}]).controller("installedCtrl", ["$scope", "$http", "config", function(a, b, c) {
		a.config = c, a.isFounder = c.isFounder, a.letters = ["全部"], angular.forEach(c.letters, function(b) {
			a.letters.push(b)
		}), a.letter = c.letter, a.module_list = c.module_list, a.allModules = c.allModules, a.moduleinfo = {}, a.cloudModule = c.cloudModule, a.upgradeInfo = {}, check_module = [], angular.forEach(a.module_list, function(a, b) {
			check_module.push(b)
		}), b.post(a.config.checkUpgradeUrl, {
			module_list: check_module
		}).success(function(b) {
			0 == b.message.errno && angular.forEach(b.message.message, function(b) {
				a.module_list[b.name].upgrade = b.upgrade, a.module_list[b.name].upgrade_info = b.upgrade_info, a.module_list[b.name].from = b.from
			})
			...
			fileUploader.init(function(c) {
				a.moduleinfo[b] = c.url,
					a.$apply(a.moduleinfo)
			}, {
				type: "image",
				direct: !0,
				multiple: !1
			...
			b.post(a.config.get_upgrade_info_url, {
				...
				0 == b.message.errno ? (a.upgradeInfo = b.message.message, $("#upgrade-info").modal("show")) : 1 == b.message.errno && util.message(b.message.message)
			})
		...
		a.config = c, a.isFounder = c.isFounder, a.receive_ban = c.receive_ban, a.moduleinfo = c.moduleInfo, a.subscribe = 2, a.checkupgrade = 0, a.show = c.show, a.editType = "", b.post(a.config.checkReceiveUrl, {
			...
			0 == c.message.errno && 1 == c.message.message[0].upgrade && (a.checkupgrade = 1, "cloud" == c.message.message[0].from ? b.post(a.config.get_upgrade_info_url, {
				...
				0 == b.message.errno ? a.upgradeInfo = b.message.message : 1 == b.message.errno && util.message(b.message.message)
		...
		}, a.editModule = function(b) {
			$("#module-info").modal("show"), a.editType = b
		}, a.changePicture = function(b) {
			fileUploader.init(function(c) {
			...
			b.post(a.config.saveModuleUrl, {
				...
				0 == b.message.errno && (util.message("修改成功", "", "success"), a.moduleinfo.logo = a.moduleinfo.logo + "?v=" + (new Date).getTime(), a.moduleinfo.preview = a.moduleinfo.preview + "?v=" + (new Date).getTime(), a.$apply(a.moduleinfo))
			})
		}, change = function(a) {
			clas = "wi wi-angle-down" == a.find("i").prop("class") ? "wi wi-angle-up" : "wi wi-angle-down", text = "wi wi-angle-down" == clas ? "查看详情" : "收起", a.html(text + '<i class="' + clas + '"></i>')
		}
		...
		card = $.parseJSON(c.card_set_str), e.add({
			...
			return 11 != b.length ? (util.message("卡号不足11位", "", "error"), !1) : (a.micro.config.loading = "加载中..", a.micro.config.card_error = "", d.post(c.card_check_url, {
				cardsn: b
			}).success(function(b) {
		...
		a.config = c, a.paysetting = c.paysetting, a.aliaccounthelp = !1, a.alipartnerhelp = !1, a.alisecrethelp = !1, a.saveEdit = function(c) {
			...
			if ("wechat" == c) {
				if (1 == a.paysetting.wechat["switch"])
					if (1 == a.paysetting.wechat.version) {
		...
		a.config = c, a.creditSetting = c.creditSetting, a.tactics = {
			...
			a.activeCredit = b, $("#credit-name").modal("show"), a.creditTitle = a.creditSetting[b].title
		...
		a.copyLink = "", a.selectUrl = function() {
			...
			var e = $("#change"),
				f = c.img_url;
			e.html('<i class="fa fa-spinner"></i> 转换中'), b.post(c.transform_url, {
				longurl: d
			}).success(function(b) {
				return -1 == b.message.errno ? (util.message(b.message.message), e.html("立即转换"), !1) : ($("#shorturl").val(b.message.message.short_url), a.copyLink = b.message.message.short_url, $(".url-short").next().attr({
					"data-url": b.message.message.short_url
				}).removeClass("disabled"), $("#qrsrc").attr("src", f + "url=" + b.message.message.short_url), $(".qr-img").next().removeClass("disabled"), e.html("立即转换"), void 0)
			})
		}, a.downQr = function() {
			var a = $("#shorturl").val(),
				b = c.down_url;
		...
		a.style = b.style, a.styles = b.styles ? b.styles : {}, a.template = b.template, a.systemtags = b.systemtags, a.customStyles = [], angular.forEach(a.styles, function(b, c) {
			...
			for (var b = $(':text[name="custom[name][]"]'), c = $(':text[name="custom[desc][]"]'), d = $(':text[name="custom[value][]"]'), e = 0; e < b.length; e++)
				if (_.isEmpty(b[e].value)) return util.message("自定义属性变量名不可为空！"), !1;
			for (var f = 0; f < c.length; f++)
				if (_.isEmpty(c[f].value)) return util.message("自定义属性变量描述不可为空！"), !1;
			for (var g = 0; g < d.length; g++)
				if (_.isEmpty(d[g].value)) return util.message("自定义属性变量值不可为空！"), !1;
			$("#submit-post").click()
		}
		...
		a.$on("serviceBase.editors.update", function(b, c) {
			...
			for (var b in a.activeModules)
				if ("header" == a.activeModules[b].id) {
		...
		a.subItemGroup = {}, a.displayStatus = {}, a.editItemPanel = function(b) {
			...
			c && confirm("确认删除此菜单？") && ("undefined" == typeof d ? b.post("./index.php?c=system&a=menu&do=delete", {
				permission_name: c
			}).success(function(a) {
		...
		a.modules = [], a.editors = [], a.activeModules = d.activeModules ? d.activeModules : [], a.activeMenus = d.activeMenus ? d.activeMenus : [], a.submit = {
			params: {},
			html: ""
		}, a.isNew = !0, a.siteroot = d.siteroot, a.logo_url = a.siteroot + "/app/resource/images/heading.jpg", _.isEmpty(a.activeModules) || 1 == a.activeModules[0].params.isnew || (a.isNew = !1), a.activeItem = {}, a.activeIndex = 0, a.index = a.activeModules.length ? a.activeModules.length : 0, g.setBaseData("index", a.index), g.setBaseData("activeModules", a.activeModules), a.pageLength = !_.isEmpty(a.activeModules) && a.activeModules[0].params.pageLength ? a.activeModules[0].params.pageLength : 1, a.isLongPage = !0, a.pageLengths = {
			1: 1,
			2: 2,
			3: 3,
			4: 4,
		...
		a.user = d.user, a.profile = d.profile, null == a.profile && (a.profile = {
			...
			address: "",
			resides: ""
		}), a.links = d.links, a.changeAvatar = function() {
			require(["fileUploader"], function(b) {
				b.init(function(b) {
		...
		a.apps = [], a.modules = [], a.show_url = [], a.tomodule = {}, a.type = 0, a.createStep = 1, a.bottom = {
			bgcolor: "#bebebe",
			boundary: "#fff",
			selectedColor: "#0f0",
			color: "#428bca"
			...
			selectedImage: "./resource/images/bottom-default.png",
			module: {}
		}], a.ifShowMenu = !0, a.submit = {}, a.prevStep = function() {
			a.createStep <= 1 ? a.createStep = 1 : a.createStep -= 1
		}, a.nextStep = function() {
		...
		}, a.selectTpl = function() {
			$(event.target).parents(".select-tem-item").addClass("active"), $(':hidden[name="template"]').val(1)
		}, a.selectHomeModule = function(b) {
			$(event.target).parents(".to-module").addClass("active").siblings().removeClass("active"), $(':hidden[name="tomodule"]').val(b), a.tomodule = b
		}, a.getLink = function(d) {
			b.post(c.getlink_url, {
				module: d
			}).success(function(b) {
				a.show_url = b.message.message
			})
		}, a.showMenu = function() {
			a.ifShowMenu = !a.ifShowMenu
		}, a.addMenu = function() {
			return a.menus.length >= 5 ? !1 : void a.menus.push({
				name: "首页",
				defaultImage: "./resource/images/bottom-default.png",
				selectedImage: "./resource/images/bottom-default.png",
				module: {}
			...
			a.menus = _.without(a.menus, a.menus[b])
		}, a.addDefaultImg = function(b) {
			fileUploader.show(function(c) {
				a.menus[b].defaultImage = c.url, a.$apply(a.menus)
			}, {
				direct: !0,
				multiple: !1
			})
			...
			fileUploader.show(function(c) {
				a.menus[b].selectedImage = c.url, a.$apply(a.menus)
			}, {
				direct: !0,
				multiple: !1
			})
			...
			switch (b) {
				case 1:
					var d = $(':text[name="name"]').val().trim(),
						e = $(".version0").val(),
						f = $(".version1").val(),
						g = $(".version2").val(),
						h = $(':hidden[name="modules"]').val().trim(),
						i = $(':text[name="account"]').val(),
						j = $(':text[name="original"]').val(),
						k = $(':text[name="key"]').val(),
						l = $(':text[name="secret"]').val();
					if (!angular.isString(d) || _.isEmpty(d)) return util.message("小程序名称不可为空！"), !1;
					if (!c.uniacid) {
						if (_.isEmpty(i)) return util.message("小程序账号不可为空！"), !1;
						if (_.isEmpty(j)) return util.message("原始ID不可为空！"), !1;
						if (_.isEmpty(k)) return util.message("AppId不可为空！"), !1;
						if (_.isEmpty(l)) return util.message("AppSecret不可为空！"), !1
					}
					return _.isEmpty(e) ? (util.message("版本号第一位有误，需不为空且为数字"), !1) : _.isEmpty(f) ? (util.message("版本号第二位有误，需不为空且为数字"), !1) : _.isEmpty(g) ? (util.message("版本号第三位有误，需不为空且为数字"), !1) : _.isEmpty(h) ? (util.message("请添加并选择至少一个应用！"), !1) : (a.modules = modulesVal, a.getLink(a.modules), !0);
				case 2:
					var m = parseInt($(':hidden[name="type"]').val());
					if (2 != m && 3 != m) return util.message("请先选择首页设计类型！"), !1;
					if (2 == m) {
						var n = $(':hidden[name="template"]').val();
						if (_.isEmpty(n)) return util.message("请选择一个模板！"), !1
					}
					if (3 == m) {
						var n = $(':hidden[name="tomodule"]').val();
						if (_.isEmpty(n)) return util.message("请选择一个应用！"), !1
					}
					return !0;
				case 3:
					return a.submit = {
						...
						original: $(':text[name="original"]').val(),
						key: $(':text[name="key"]').val(),
						secret: $(':text[name="secret"]').val(),
						...
						tomodule: a.tomodule,
						showmenu: a.ifShowMenu,
						buttom: a.bottom,
						menus: a.menus
					}, a.menus.length < 2 ? (util.message("请至少设置两个底部菜单！"), !1) : !0;
				case 4:
					return !0;
				default:
					return !1
		...
		a.uniacid = c.uniacid, a.multiid = c.multiid, a.success_url = c.success_url, a.account_list = [], a.current_module = "", a.category = {
			...
			b.post(c.links.saveConnection, {
				...
				0 == b.message.errno ? ($(".js-connection-img-" + a).attr("src", b.message.message.thumb), $(".js-connection-name-" + a).text(b.message.message.name), util.message("修改成功", "", "success")) : util.message(b.message.message, "", "error"), $("#show_account").modal("hide")
			})
		...
		return {
			...
			link: function(b) {
				b.selectMore = function() {
					if ($("#modules-Modal").modal("show"), _.isEmpty(b.apps)) {
						var c = $(".modules-content .tab-content .app-allow-list");
						c.html('<div class="info text-center"><i class="fa fa-spinner fa-pulse fa-lg"></i> 数据加载中</div>');
						var d = "./index.php?c=wxapp&a=post&do=getapps";
						a({
							method: "POST",
							url: d,
							cache: !0
						}).success(function(a, d) {
							b.apps = a.message.message;
							var e = "";
							angular.forEach(b.apps, function(a, b) {
								e += '<li>	<div class="app-info">		<img src="' + a.module_icon + '" />		<p>' + a.module_title + '</p>	</div>	<a href="javascript:;" onclick="selectModule(\'' + a.module + "', '" + a.module_title + "', '" + a.module_icon + "', '" + a.bindings + "', '" + a.version + '\')" class="cover-dark">		<i class="fa fa-check cover-selected"></i>	</a></li>'
							}), c.html(e)
						}).error(function(a, b) {
							c.html('<div class="info text-center">数据加载失败，点此<button class="btn btn-link"  ng-click="selectMore()">重新加载</button></div>')
						})
					} else {
						var e = "",
							c = $(".modules-content .tab-content .app-allow-list");
						angular.forEach(b.apps, function(a, b) {
							e += '<li>	<div class="app-info">		<img src="' + a.module_icon + '" />		<p>' + a.module_title + '</p>	</div>	<a href="javascript:;" onclick="selectModule(\'' + a.module + "', '" + a.module_title + "', '" + a.module_icon + "', '" + a.bindings + "', '" + a.version + '\')" class="cover-dark">		<i class="fa fa-check cover-selected"></i>	</a></li>'
						}), c.html(e)
					}
