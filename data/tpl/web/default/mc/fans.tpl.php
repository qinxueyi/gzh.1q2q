					...
					<tr>
						<th class="text-left" colspan="5">
							<div class="we7-form">
								...
								<a href="javascript:;" class="btn btn-default we7-margin-left-sm" ng-click="sync('all')">同步全部粉丝信息</a>
								<a href="javascript:;" class="btn btn-default we7-margin-left-sm" ng-click="downloadFans()">下载全部粉丝信息</a>
								<!-- <label>同步会员信息
