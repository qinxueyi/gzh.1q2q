<?php defined('IN_IA') or exit('Access Denied');?></div>
	<!-- <div class="container-fluid footer text-center" role="footer">	
		...
		<div class="copyright"><?php  if(empty($_W['setting']['copyright']['footerleft'])) { ?>Powered by <a href="www.we7.cc"><b>微擎</b></a> v<?php echo IMS_VERSION;?> &copy; 2015-2018 <a href="http://www.we7.cc">www.we7.cc</a><?php  } else { ?><?php  echo $_W['setting']['copyright']['footerleft'];?><?php  } ?></div>
